...
python generateTestImage.py 32 8 3 grid3DRef32.nii grid3DTar32.nii
python generateTestImage.py 64 8 3 grid3DRef64.nii grid3DTar64.nii
python generateTestImage.py 128 8 3 grid3DRef128.nii grid3DTar128.nii
python generateTestImage.py 256 8 3 grid3DRef256.nii grid3DTar256.nii
