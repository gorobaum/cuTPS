  ...
  for i in {1..30};
    do ./tps ../3dconfigurations/config3DerrorCheckAllOff.txt >> resultsErrorCheckAllOff.txt;
  done

  for i in {1..30};
    do ./tps ../3dconfigurations/config3DerrorCheckOccupancy.txt >> resultsErrorCheckOccupancy.txt;
done

for i in {1..30};
  do ./tps ../3dconfigurations/config3DerrorCheckParallel.txt >> resultsErrorCheckParallel.txt;
done

for i in {1..30};
  do ./tps ../3dconfigurations/config3DerrorCheckAllOn.txt >> resultsErrorCheckAllOn.txt;
done
