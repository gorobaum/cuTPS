...
namespace tps {
  ...
  bool InstanceConfiguration::hasConfiguration(std::string configurationName) {
    std::unordered_map<std::string,std::string>::iterator it;
    it = currentConfiguration_.find(configurationName);
    return it != currentConfiguration_.end();
  }
  ...
  std::vector<int> InstanceConfiguration::getIntVector(
      std::string configurationName) {
    std::vector<int> result;
    std::string vectorString =
      findInConfiguration(configurationName)->second;
